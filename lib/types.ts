...
export type Order = { id: string; customer: { name: string; address: string; phone: string }; items: CartItem[]; total: number; status: OrderStatus; screenshot?: string; createdAt: string };
